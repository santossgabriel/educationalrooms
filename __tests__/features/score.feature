Feature: Scores
  Para obter as pontuações
  Como usuário do sistemas
  Quero poder obter minhas pontuações e as de minhas salas

  Scenario: Obter pontuações
  ...
  Scenario: Obter pontuações para o gráfico
