Feature: Gerenciamento de questões
  ...
  Scenario Outline: Criar questão
    ...
    Examples:
      ...
      | 'sem respostas'                     | '{"answers": null}'                                                                                                                                                                                                                                   | "A questão deve ter entre 2 e 6 respostas."               |
      | 'com um número menor de respostas'  | '{"answers": [{}]}'                                                                                                                                                                                                                                   | "A questão deve ter entre 2 e 6 respostas."               |
      | 'com um númerio maior de respostas' | '{"answers": [{}, {}, {}, {}, {}, {}, {}]}'                                                                                                                                                                                                           | "A questão deve ter entre 2 e 6 respostas."               |
      ...
      | 'sem dificuldade'                   | '{"difficulty": 0}'                                                                                                                                                                                                                                   | "A dificuldade deve estar entre 1 e 5."                   |
  ...
  Scenario Outline: Atualizar questão
    ...
    Examples:
      ...
      | 'sem respostas'                     | '{"answers": null}'                                                                                                                                                                                                                                       | "A questão deve ter entre 2 e 6 respostas."               |
      | 'com um número menor de respostas'  | '{"answers": [{}]}'                                                                                                                                                                                                                                       | "A questão deve ter entre 2 e 6 respostas."               |
      | 'com um número maior de respostas'  | '{"answers": [{}, {}, {}, {}, {}, {}, {}]}'                                                                                                                                                                                                               | "A questão deve ter entre 2 e 6 respostas."               |
      | 'com alguma resposta sem descrição' | '{"answers": [{"description": "", "classification": "A"}, {"description": "teste", "classification": "B"}, {"description": "teste", "classification": "C"}, {"description": "teste", "classification": "D"}]}'                                            | "A questão possui respostas sem descrição."               |
      ...
      | 'questão inexistente'               | '{"id": 99}'                                                                                                                                                                                                                                              | "A questão não foi localizada."                           |
