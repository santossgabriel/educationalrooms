Feature: Gerenciamento de questões
    ...
    Scenario Outline: Atualizar questão
        ...
        When Quando eu atualizar a questão <caso> atribuindo <propriedade>
        Then Então eu devo obter a mensagem <mensagem> depois de tentar atualizar a questão
    ...
    Scenario Outline: Remover questão
        ...
        When eu tentar remover uma questão <caso> <id>
        Then depois de tentar remover a questão eu devo obter a mensagem <mensagem>
